...
type Service interface {
	...
	GetAddresses(n network.Network, pagination framework.Pagination, sort framework.Sort) ([]*explorer.Address, int64, error)
...
func (s *service) GetAddresses(n network.Network, pagination framework.Pagination, sort framework.Sort) ([]*explorer.Address, int64, error) {
	return s.addressRepository.GetAddresses(n, pagination.Size(), pagination.Page(), sort)
}
